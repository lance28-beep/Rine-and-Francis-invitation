...
export const principalSponsors = [
  { name: "Hon. Ernie Uy", spouse: "Hon. Joeterry Uy" },
  { name: "Mr. Richard Anfone", spouse: "Mrs. Letecia Anfone" },
  { name: "Mr. Gil Socorro", spouse: "Mrs. Ieny Socorro" },
  { name: "Mr. Jimmy Malacapay", spouse: "Mrs. Lelanie Malacapay" },
  { name: "Mr. Alan Delos Reyes", spouse: "Mrs. Iely Delos Reyes" },
  { name: "Mr. Rey Anfone", spouse: "Mrs. Perlita Anfone" },
  { name: "Mr. Peter U. Yu", spouse: "Mrs. Naomie Yu" },
  { name: "Engr. Lyster Miraflor", spouse: "Mrs. Sarah Miraflor" },
  { name: "Engr. Noel Galarpe", spouse: "Mrs. Erminda Galarpe" },
  { name: "Mr. Hendrick Emperado", spouse: "Dr. Rasanie Emperado" },
  { name: "Dr. Caryl Riconalla", spouse: "Dr. Joan Dee Riconalla" },
  { name: "Mr. Eduardo Diao", spouse: "Mrs. Lilian Diao" },
  { name: "Mr. Richard Cabugnason", spouse: "Mrs. Verlita Cabugnason" },
  { name: "Rev. Elmer Providencia", spouse: "Mrs. Gina Providencia" },
  { name: "Rev. Callum Tabada", spouse: "Pstr. Dominga Tabada" },
  { name: "Rev. Jessie Pagalan", spouse: "Rev. Charity Torralba" },
  { name: "Mr. Alejo Daniel", spouse: "Mrs. Fredelin Berjolano" },
  { name: "Rev. Lope Robin", spouse: "Mrs. Juliet Aviles" },
  { name: "Rev. Jerome Nalam", spouse: "Dr. Jean Nalam" },
  { name: "Rev. Danny dela Rama", spouse: "Rev. Priscilla Casido" },
  { name: "Mr. Doel Wetzel Pacana", spouse: "Ms. Ellanie Joy Pacana" },
  { name: "Mr. Wilson Cadalso, Sr.", spouse: "Mrs. Corazon Cadalso" },
]
