  ...
  const CountdownUnit = ({ value, label }: { value: number; label: string }) => (
      <div className="flex flex-col items-center gap-3 sm:gap-4 md:gap-5">
        <div className="relative group">
          ...
          <div className="absolute -inset-4 bg-gradient-to-r from-[#D1AB6D]/20 via-[#E0CFB5]/15 to-[#D1AB6D]/20 rounded-full blur-2xl opacity-40 animate-pulse" />
          <div className="absolute -inset-3 bg-gradient-to-r from-[#D1AB6D]/30 via-[#E0CFB5]/20 to-[#D1AB6D]/30 rounded-full blur-md opacity-50 animate-pulse" style={{ animationDelay: '0.5s' }} />
          
          {/* Decorative glow effect on hover */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#D1AB6D]/40 via-[#E0CFB5]/20 to-[#D1AB6D]/40 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700 scale-110" />

          {/* Enhanced decorative corner accents with animation */}
          <div className="absolute -top-2 -left-2 w-5 h-5 bg-gradient-to-br from-[#D1AB6D] via-[#E0CFB5] to-[#D1AB6D] rounded-full blur-sm opacity-70 shadow-lg animate-pulse" />
          <div className="absolute -top-2 -right-2 w-5 h-5 bg-gradient-to-bl from-[#D1AB6D] via-[#E0CFB5] to-[#D1AB6D] rounded-full blur-sm opacity-70 shadow-lg animate-pulse" style={{ animationDelay: '0.3s' }} />
          <div className="absolute -bottom-2 -left-2 w-5 h-5 bg-gradient-to-tr from-[#D1AB6D] via-[#E0CFB5] to-[#D1AB6D] rounded-full blur-sm opacity-70 shadow-lg animate-pulse" style={{ animationDelay: '0.6s' }} />
          <div className="absolute -bottom-2 -right-2 w-5 h-5 bg-gradient-to-tl from-[#D1AB6D] via-[#E0CFB5] to-[#D1AB6D] rounded-full blur-sm opacity-70 shadow-lg animate-pulse" style={{ animationDelay: '0.9s' }} />

        {/* Main card with enhanced multi-layer styling */}
        <div className="relative bg-gradient-to-br from-[#F0F0F0] via-[#E0CFB5]/50 to-[#F0F0F0] backdrop-blur-md rounded-3xl p-5 sm:p-7 md:p-9 border-2 border-[#D1AB6D]/60 shadow-[0_8px_32px_rgba(82,94,44,0.3),0_0_0_1px_rgba(209,171,109,0.2)] hover:shadow-[0_12px_48px_rgba(82,94,44,0.4),0_0_40px_rgba(209,171,109,0.5)] transition-all duration-700 min-w-24 sm:min-w-28 md:min-w-36 lg:min-w-44 hover:scale-[1.08] hover:border-[#D1AB6D]">
          ...
          <div className="absolute inset-2 border border-[#D1AB6D]/40 rounded-2xl group-hover:border-[#D1AB6D]/60 transition-all duration-500" />
          
          {/* Additional inner glow */}
          <div className="absolute inset-3 bg-gradient-to-br from-[#D1AB6D]/10 to-transparent rounded-2xl group-hover:from-[#D1AB6D]/20 transition-all duration-500" />
          ...
          <div className="absolute top-3 right-3 w-3 h-3 bg-[#D1AB6D] rounded-full animate-ping opacity-80 shadow-lg" />
          <div className="absolute bottom-4 left-4 w-2 h-2 bg-[#909E8D] rounded-full animate-pulse opacity-70 shadow-md" style={{ animationDelay: '0.7s' }} />
          <div className="absolute top-1/2 left-2 w-1.5 h-1.5 bg-[#E0CFB5] rounded-full animate-pulse opacity-50" style={{ animationDelay: '1.4s' }} />
        </div>
      </div>

      {/* Label with enhanced styling */}
      <div className="relative">
        <span className="text-sm sm:text-base md:text-lg font-bold text-[#E0CFB5] uppercase tracking-widest drop-shadow-lg relative z-10 group-hover:text-[#D1AB6D] transition-colors duration-500">
          {label}
        </span>
        {/* Label background glow with multiple layers */}
        <div className="absolute inset-0 bg-[#D1AB6D]/10 rounded-lg blur-sm -z-10 group-hover:bg-[#D1AB6D]/20 transition-all duration-500" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#D1AB6D]/5 via-[#E0CFB5]/10 to-[#D1AB6D]/5 rounded-lg blur-md -z-20 group-hover:from-[#D1AB6D]/10 group-hover:via-[#E0CFB5]/15 group-hover:to-[#D1AB6D]/10 transition-all duration-500" />
      </div>
    </div>
  )
    ...
    >
      ...
      <div className="relative z-10 text-center mb-16 md:mb-20">
        ...
        <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-bold text-[#E0CFB5] mb-6 text-balance drop-shadow-lg relative">
          ...
          {/* Text glow effect */}
          <span className="absolute inset-0 text-[#D1AB6D]/20 blur-2xl -z-10">Count Down With Us</span>
        </h2>
        
        <div className="flex items-center justify-center gap-4 mb-8">
        </div>
        
        <p className="text-lg md:text-xl text-[#F0F0F0] font-sans font-light max-w-2xl mx-auto px-4 leading-relaxed">
